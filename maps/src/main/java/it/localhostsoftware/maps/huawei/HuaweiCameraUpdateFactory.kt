...
class HuaweiCameraUpdateFactory : it.localhostsoftware.maps.CameraUpdateFactory {
    ...
    override fun newCameraPosition(var0: CameraPosition<*>) =
            CameraUpdate(CameraUpdateFactory.newCameraPosition(var0.cp as com.huawei.hms.maps.model.CameraPosition))

    override fun newLatLng(var0: LatLng<*>) =
            CameraUpdate(CameraUpdateFactory.newLatLng(var0.ll as com.huawei.hms.maps.model.LatLng))

    override fun newLatLngZoom(var0: LatLng<*>, var1: Float) =
            CameraUpdate(CameraUpdateFactory.newLatLngZoom(var0.ll as com.huawei.hms.maps.model.LatLng, var1))

    override fun newLatLngBounds(var0: LatLngBounds<*>, var1: Int) =
            CameraUpdate(CameraUpdateFactory.newLatLngBounds(var0.lb as com.huawei.hms.maps.model.LatLngBounds, var1))

    override fun newLatLngBounds(var0: LatLngBounds<*>, var1: Int, var2: Int, var3: Int) =
            CameraUpdate(CameraUpdateFactory.newLatLngBounds(var0.lb as com.huawei.hms.maps.model.LatLngBounds, var1, var2, var3))
}