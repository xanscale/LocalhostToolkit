...
public class GooglePolygon extends Polygon<com.google.android.gms.maps.model.Polygon> {
    ...
    public void setPoints(@NonNull List<LatLng<?>> var1) {
        List<com.google.android.gms.maps.model.LatLng> out = new ArrayList<>(var1.size());
    ...
    public List<LatLng<?>> getPoints() {
        ...
        for (com.google.android.gms.maps.model.LatLng value : getPolygon().getPoints())
    ...
    public void setHoles(@NonNull List<? extends List<LatLng<?>>> var1) {
        List<List<com.google.android.gms.maps.model.LatLng>> out = new ArrayList<>(var1.size());
        for (List<LatLng<?>> subIn : var1) {
            out.add(new ArrayList<>(subIn.size()));
            for (LatLng<?> value : subIn)
                out.get(out.size() - 1).add((com.google.android.gms.maps.model.LatLng) value.getLatLng());
        }
    ...
    public List<List<LatLng<?>>> getHoles() {
        ...
        for (List<com.google.android.gms.maps.model.LatLng> subIn : getPolygon().getHoles()) {
            out.add(new ArrayList<>(subIn.size()));
    ...
    public void setStrokePattern(@Nullable List<PatternItem<?>> var1) {
        if (var1 == null)
            ...
            List<com.google.android.gms.maps.model.PatternItem> out = new ArrayList<>(var1.size());
    ...
    public List<PatternItem<?>> getStrokePattern() {
        if (getPolygon().getStrokePattern() == null)
            ...
            for (com.google.android.gms.maps.model.PatternItem value : getPolygon().getStrokePattern())
