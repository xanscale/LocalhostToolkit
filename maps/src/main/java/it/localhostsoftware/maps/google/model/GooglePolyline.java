...
public class GooglePolyline extends Polyline<com.google.android.gms.maps.model.Polyline> {
    ...
    public void setPoints(List<LatLng<?>> var1) {
        ArrayList<com.google.android.gms.maps.model.LatLng> out = new ArrayList<>(var1.size());
    ...
    public List<LatLng<?>> getPoints() {
        ...
        for (com.google.android.gms.maps.model.LatLng value : getPolyline().getPoints())
    ...
    public void setStartCap(@NonNull Cap<?> var1) {
        getPolyline().setStartCap((com.google.android.gms.maps.model.Cap) var1.getCap());
    }
    ...
    public void setEndCap(@NonNull Cap<?> var1) {
        getPolyline().setEndCap((com.google.android.gms.maps.model.Cap) var1.getCap());
    }
